<header class="admin-header">
        <div class="admin-header__brand">
            ...
            <a href="#" id="admin-header__logo-link" aria-label="Go to homepage" class="admin-header__logo-wrapper">
                <img src="/petcareweb/petcareweb_admin/assets/images/logo/logo.svg" alt="Logo" class="logo-image">
        ...
        <div class="admin-header__toolbar">
            ...
            <div class="admin-header__actions">
                ...
                <div class="admin-header__profile">
                    <img src="/petcareweb_admin/assets/images/avatar/animal-avatar-bear.svg" alt="Cartoon bear avatar..." class="admin-header__profile-image">
