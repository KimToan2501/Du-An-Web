<footer id="footer">
    <div class="pawspa__container pawspa__flex-between">
        <div class="pawspa-footer__info">
            <img src="<?= base_url('assets/images/icons/Union.svg') ?>" alt="Logo Pawspa" class="pawspa-footer__logo">
            ...
            <div class="pawspa-footer__contact">
                <div class="pawspa-footer__contact-item">
                    <img src="<?= base_url('assets/images/icons/letter.svg') ?>" alt="Email" class="pawspa-footer__contact-icon">
                    <a href="mailto:chaumlp@gmail.com" class="pawspa-footer__contact-address">pawspa@gmail.com</a>
                </div>
                <div class="pawspa-footer__contact-item">
                    <img src="<?= base_url('assets/images/icons/phone.svg') ?>" alt="Phone" class="pawspa-footer__contact-icon">
                    <a href="tel:0345663153" class="pawspa-footer__contact-address">0123456789</a>
                </div>
            </div>
            <div class="pawspa-footer__social">
                <a href="#" title="Instagram">
                    <img src="<?= base_url('assets/images/icons/social-media/ins.svg') ?>" alt="Instagram"
                        class="pawspa-footer__social-icon">
                </a>
                <a href="#" title="Facebook">
                    <img src="<?= base_url('assets/images/icons/social-media/fb.svg') ?>" alt="Facebook"
                        class="pawspa-footer__social-icon">
                </a>
                <a href="#" title="LinkedIn">
                    <img src="<?= base_url('assets/images/icons/social-media/link.svg') ?>" alt="LinkedIn"
                        class="pawspa-footer__social-icon">
                </a>
            </div>
        </div>
        ...
        <div class="pawspa-footer__image">
            <div>
                <div>
                    <img src="<?= base_url('assets/images/footer/Rectangle 170.svg') ?>" alt="" aria-hidden="true">
                </div>
            </div>
        </div>
    ...
    <div class="pawspa-footer__image--left">
        <img src="<?= base_url('assets/images/footer/footer-01.svg') ?>" alt="">
    </div>
