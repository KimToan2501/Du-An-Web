              ...
              <div class="col-12 mb-4">
                <div class="text-center">
                  <div class="pet-avatar-upload">
                    <img id="avatarPreview" src="<?= base_url($pet->avatar_url ?: 'assets/images/default-pet.jpg') ?>"
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="text" id="name" name="name" required class="form-control"
                    placeholder="Nhập tên thú cưng" maxlength="100" value="<?= $pet->name ?>">
                </div>
              </div>
                ...
                <div class="mb-3">
                  ...
                  <select id="type" name="type" required class="form-select">
                    ...
                    <?php foreach ($types as $key => $type): ?>
                      <option value="<?= $key ?>" <?= $key == $pet->type ? 'selected' : '' ?>><?= $type ?></option>
                    <?php endforeach; ?>
                  </select>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="text" id="breed" name="breed" class="form-control"
                    placeholder="Nhập giống thú cưng" maxlength="100" value="<?= $pet->breed ?>">
                </div>
              </div>
                ...
                <div class="mb-3">
                  ...
                  <select id="gender" name="gender" class="form-select">
                    ...
                    <?php foreach ($genders as $key => $gender): ?>
                      <option value="<?= $key ?>" <?= $key == $pet->gender ? 'selected' : '' ?>><?= $gender ?></option>
                    <?php endforeach; ?>
                  </select>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  ...
                  <input type="number" id="age" name="age" min="0" max="50" class="form-control"
                    placeholder="Nhập tuổi" value="<?= $pet->age ?>">
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  ...
                  <select id="age_unit" name="age_unit" class="form-select">
                    ...
                    <?php foreach ($ageUnits as $key => $ageUnit): ?>
                      <option value="<?= $key ?>" <?= $key == $pet->age_unit ? 'selected' : '' ?>><?= $ageUnit ?></option>
                    <?php endforeach; ?>
                  </select>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  ...
                  <input type="number" id="weight" name="weight" min="0" step="0.1" class="form-control"
                    placeholder="Nhập cân nặng" value="<?= $pet->weight ?>">
                </div>
              </div>
                ...
                <div class="mb-3">
                  ...
                  <select id="size" name="size" class="form-select">
                    ...
                    <?php foreach ($sizes as $key => $size): ?>
                      <option value="<?= $key ?>" <?= $key == $pet->size ? 'selected' : '' ?>><?= $size ?></option>
                    <?php endforeach; ?>
                  </select>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="text" id="color" name="color" class="form-control"
                    placeholder="Nhập màu sắc lông/da" maxlength="100" value="<?= $pet->color ?>">
                </div>
              </div>
              ...
              <div class="col-12">
                <div class="mb-3">
                  ...
                  <textarea id="medical_notes" name="medical_notes" rows="3" class="form-control"
                    placeholder="Nhập thông tin về tình trạng sức khỏe, bệnh lý, thuốc đang dùng..."><?= $pet->medical_notes ?></textarea>
                </div>
              </div>
              ...
              <div class="col-12">
                <div class="mb-3">
                  ...
                  <textarea id="behavioral_notes" name="behavioral_notes" rows="3" class="form-control"
                    placeholder="Nhập thông tin về tính cách, hành vi, sở thích của thú cưng..."><?= $pet->behavioral_notes ?></textarea>
                </div>
              </div>
            </div>
...
<script>
  $(document).ready(function() {
    ...
    $('#addPetForm').on('submit', function(e) {
      ...
      $.ajax({
        url: '<?= base_url('/user/pets/' . $pet->pet_id) ?>',
        method: 'POST',
        data: formData,
        processData: false,
        contentType: false,
        success: function(response) {
          swAlert('Thông báo', response.message || 'Cập nhật thú cưng thành công!', 'success');
          setTimeout(function() {
            window.location.href = '<?= base_url('/user/pets') ?>';
          }, 1500);
        },
        error: function(xhr) {
          let errorMessage = 'Đã xảy ra lỗi khi cập nhật thú cưng';
